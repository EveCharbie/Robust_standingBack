...
def prepare_ocp(biorbd_model_path, phase_time, n_shooting, min_bound, max_bound):
    ...
    # objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_STATE, key="qdot", weight=1, phase=5)
    ...
    # pose_landing_start = [0.1987, 1.7551, 5.8322, 0.52, 0.95, 1.5, -1.64, 0.7]
    ...
    pose_landing_start = [-0.9554004763233065, 0.15886445602166693, 5.832254254152056, -0.45610833795726297, 0.03,
                          0.6704528346396729, -0.5304889643328282, 0.654641794221728]
...
def main():
    ...
    ocp, bio_model = prepare_ocp(
        ...
        # n_shooting=(20, 10, 20, 30, 30, 30),
        n_shooting=(20, 10, 10, 40, 10, 20),
        min_bound=0.01,   # 0.01 ou 1
        max_bound=np.inf,
    )
