...
path_without = (
    "/home/charbie/Documents/Programmation/Robust_standingBack/holonomic_research/solutions/"
)
path_CL = "/home/mickaelbegon/Documents/Anais/Robust_standingBack/holonomic_research/solutions_CL/"
...
if PLOT_INERTIA_FLAG:
    ...
    ax[0].plot(
        ...
        alpha=0.75,
        linewidth=1,
    )  # time_pourcentage_without.flatten(),
    ax[0].plot(
        time_vector_CL,
        inertia_CL[:, 0],
        color="tab:orange",
...
if PLOT_ENERY_FLAG:
    ...
    time_tau_without = np.hstack(
        (
            time_vector_without[:20],
