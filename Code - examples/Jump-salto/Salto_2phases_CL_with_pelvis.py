...
def prepare_ocp(biorbd_model_path, phase_time, n_shooting, min_bound, max_bound):
    ...
    x_bounds[0][:, 0] = pose_salto_tendu + [0] * n_qdot
    # x_bounds["q"][1][0, :].min = -10
    # x_bounds["q"][1][0, :].max = 10
    # x_bounds["q"][1][1, :].min = -10
    # x_bounds["q"][1][1, :].max = 10
    # x_bounds["q"][1][2, :].min = -10
    # x_bounds["qdot"][1][2, :].max = 10
    # x_bounds["qdot"][1][0, :].min = -10
    # x_bounds["qdot"][1][0, :].max = 10
    # x_bounds["qdot"][1][1, :].min = -10
    # x_bounds["qdot"][1][1, :].max = 10
    # x_bounds["qdot"][1][2, :].min = -10
    # x_bounds["qdot"][1][2, :].max = 10
    ...
    x_init.add("q", np.array([pose_salto_tendu_CL, pose_salto_groupe_CL]).T, interpolation=InterpolationType.LINEAR, phase=1)
    x_init.add("qdot", np.array([[0] * n_independent, [0] * n_independent]).T, interpolation=InterpolationType.LINEAR, phase=1)
