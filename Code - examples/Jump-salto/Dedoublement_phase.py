...
def prepare_ocp(biorbd_model_path, phase_time, n_shooting, min_bound, max_bound):
    ...
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=0)   #, derivative=True
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=10000, phase=1, min_bound=0.1, max_bound=0.3)
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=1) #, derivative=True
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=-10000, phase=2, min_bound=0.1, max_bound=0.5)
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=2) #, derivative=True
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=-10000, phase=3, min_bound=0.01, max_bound=0.5)
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_COM_POSITION, node=Node.END,  weight=-10000, phase=3)
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=3)   #, derivative=True
    # objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_STATE, key="qdot", weight=1, phase=3)#, derivative=True
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=100, phase=4, min_bound=0.3, max_bound=1.5)
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=-10, phase=5, min_bound=0.01, max_bound=0.3)
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=-10000, phase=7, min_bound=0.1, max_bound=0.5)
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_COM_POSITION, node=Node.END,  weight=-10000, phase=7)
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", weight=1, phase=7)   #, derivative=True
    # objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_STATE, key="qdot", weight=1, phase=7, derivative=True)
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=100, phase=8, min_bound=0.3, max_bound=1.5)
    ...
    objective_functions.add(ObjectiveFcn.Mayer.MINIMIZE_TIME, weight=-10, phase=9, min_bound=0.01, max_bound=0.3)
...
def main():
    ocp = prepare_ocp(
        ...
        phase_time=(0.3, 0.15, 0.2, 0.3, 1, 0.2, 0.2, 0.3, 1, 0.2, 0.2),
        n_shooting=(30, 15, 20, 30, 100, 20, 20, 30, 100, 20, 20),
        min_bound=0,
        max_bound=np.inf,
    )
...
# --- Solve the program --- #
    ...
    # --- Show/Save results --- #
    save_results(sol, str(movement) + "_" + str(nb_phase_total) + "phases_V" + str(version))
    sol.print_cost()
