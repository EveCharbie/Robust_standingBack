...
Model2D.write("\tRTinMatrix\t1\n")
Model2D.write("\tRT\n\t\t" + str(Matrice_rotation_x[0][0]) + " " + str(Matrice_rotation_x[0][1]) + " " + str(Matrice_rotation_x[0][2]) + " "
              + str((model3D.localJCS()[12].to_array()[0][3] + model3D.localJCS()[12 + 4].to_array()[0][3]) / 2) + "\n\t\t"
              + str(Matrice_rotation_x[1][0]) + " " + str(Matrice_rotation_x[1][1]) + " " + str(Matrice_rotation_x[1][2]) + " " + str((model3D.localJCS()[12].to_array()[1][3] + model3D.localJCS()[12 + 4].to_array()[1][3]) / 2) + "\n\t\t"
              + str(Matrice_rotation_x[2][0]) + " " + str(Matrice_rotation_x[2][1]) + " " + str(Matrice_rotation_x[2][2]) + " "
